...
const ProjectsWithModal = () => {
  ...
  const ProjectCard = ({ project }: { project: ProjectDetail }) => (
    <button
      ...
      className="min-w-[min(85vw,18rem)] shrink-0 cursor-pointer rounded-md border border-zinc-800 bg-zinc-900/80 p-3 text-left opacity-90 backdrop-blur-sm transition-colors duration-200 hover:bg-zinc-800 sm:min-w-[14rem] md:min-w-[16rem]"
    >
  ...
  return (
    <div id="projects" className="px-4 pb-8 sm:px-6 md:px-10">

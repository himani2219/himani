...
const Experience = () => {
    ...
    const ExperienceCard = ({experience}: {experience: Experience})=>{
        return (
            <div className="border border-zinc-800 opacity-90 backdrop-blur-sm p-3 rounded-md w-200 min-w-50 hover:bg-zinc-800 transition-colors duration-200  ">
                <h4 className='text-[20px] font-semibold mb-2'>{experience.role}</h4>

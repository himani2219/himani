    ...
    const projects = [
        {
            ...
            techstack:['Next.js', 'Node.js', 'Express.js', 'PostgreSQL', 'Passport.js', 'Socket.io', 'JWT'],
        ...
        },
        {
            ...
            techstack:['React.js', 'Node.js', 'Express.js', 'Web Speech API', 'Geolocation API', 'OpenWeather API'],
